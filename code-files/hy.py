...
def app():
    ...
    acc_data = pd.read_csv('data/hsis-csv/wa13acc.csv')
    road_data = pd.read_csv('data/hsis-csv/wa13road.csv')
    veh_data = pd.read_csv('data/hsis-csv/wa13veh.csv')
    occ_data = pd.read_csv('data/hsis-csv/wa13occ.csv')
    acc_veh_all = pd.read_csv('data/acc_veh_all.csv')
    acc_rd = pd.read_csv('data/acc_rd.csv')
    #图1
